...
- Use GSMArena phone data for device specifications instead of guessing model details. Use NanoReview or Technical City when the user asks for those sources; never invent their data.
